...
class CIM(nn.Module):
    # def __init__(self, dim, num_layers=1, channels=[196, 392, 784, 1568], downsample=1):
...
if __name__ == '__main__':
    model = CIM(2940)
    x1 = torch.randn(2, 196, 120, 120)
    x2 = torch.randn(2, 392, 60, 60)
    x3 = torch.randn(2, 784, 30, 30)
    x4 = torch.randn(2, 1568, 15, 15)
    x = tuple([x1, x2, x3, x4])

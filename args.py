...
def get_parser():
    parser = argparse.ArgumentParser(description='PVLMamba training and testing')
    ...
    parser.add_argument('--model_id', default='fianl_PVLMamba_RRISS', help='name to identify the model')
    parser.add_argument('--output-dir', default='/hy-tmp/weight/', help='path where to save checkpoint weights')
    ...
    parser.add_argument('--refer_data_root', default='/hy-tmp/RRSIS-D/', help='REFER dataset root directory')
    parser.add_argument('--resume', default='', help='resume from checkpoint')
    # /hy-tmp/weight/MFNet_refsegrs.pth /hy-tmp/weight/rrsis_mm_77.pth
